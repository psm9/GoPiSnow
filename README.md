...
I saw an article in MagPi about controlling a Raspberry Pi using Alexa. In trying to set that up, I stumbled on thiss solution instead using [Snowboy](http://docs.kitt.ai/snowboy/)
